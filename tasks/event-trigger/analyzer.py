...
if __name__ == '__main__':
    ...
    # writing prompts
    output_dir = f'{BASE_DIR}/output/event-trigger/gen_result_for_etrica_wp'
    retrieve_gen_result(dir_key_words=["leading-plus-event", "writing-prompts"],
                        file_key_words=["gen.txt"],
                        discard_dir_key_words=discard_dir_key_words,
                        discard_file_key_words=discard_file_key_words,
                        result_dir=f'{BASE_DIR}/output/event-trigger',
                        output_dir=output_dir)
    retrieve_gen_result(dir_key_words=["event-lm", "writing-prompts"],
                        file_key_words=["gen.txt"],
                        discard_dir_key_words=discard_dir_key_words,
                        discard_file_key_words=discard_file_key_words,
                        result_dir=f'{BASE_DIR}/output/event-trigger',
                        output_dir=output_dir)
    clean_hint_gen_file(f'{output_dir}/leading-plus-event-hint-writing-prompts.test_event.source_gen.txt')