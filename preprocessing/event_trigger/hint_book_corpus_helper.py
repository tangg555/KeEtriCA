...
if __name__ == '__main__':
    ...
    output_dir = Path(f"{BASE_DIR}/resources/datasets/event-trigger/book-corpus")
    ...
    # copy val to test --------------
    src_clean(src_dir.joinpath(f"val.source"), output_dir.joinpath(f"test.source.txt"))
    target_clean(src_dir.joinpath(f"val.target"), output_dir.joinpath(f"test.target.txt"))
